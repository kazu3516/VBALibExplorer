...
namespace LibraryExplorer.Window {
    ...
    public partial class MainWindow : Form {
        ...
        //TODO:Excelファイルを指定し、その中で使用されているライブラリが最新かどうかチェックする機能を作成する。(テンポラリフォルダにエクスポートして比較する。winmerge or csdiff。デフォルトはfcコマンド[fc フォルダ1\* フォルダ2\*]で比較可能)
        ...
        //TODO:Excelファイルを処理する機能(外部のVBScriptを起動 or VBScriptを動的に生成して起動する)
